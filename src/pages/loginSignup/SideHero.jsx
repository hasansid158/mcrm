      ...
      >
        ...
        <Box display={'flex'} flexDirection={'row'} gap={2}>
          ...
          >
            ...
            >
              Seamless Data Integration: Start with preloaded data or
              effortlessly upload your own to hit the ground running. Our
              platform is designed to make your transition smooth and
              hassle-free.
            </Typography>
            ...
            <Typography
              ...
              fontSize={{ xs: '14px', sm: '16px', md: '18px', lg: '18px' }}
            >
              Customizable Solutions: Dive into preconfigured processes,
              reports, and dashboards tailored to your business needs. Our
              flexible system adapts to you, providing valuable insights to
              drive growth.
            </Typography>
            ...
            <Typography
              ...
              fontSize={{ xs: '14px', sm: '16px', md: '18px', lg: '18px' }}
            >
              Personalized User Experiences: Navigate through our CRM with ease
              and confidence, maximizing productivity.
            </Typography>
            ...
            <Typography
              ...
              fontSize={{ xs: '14px', sm: '16px', md: '18px', lg: '18px' }}
            >
              Comprehensive Support and Learning: We're committed to your
              success and provide continuous support and learning opportunities
